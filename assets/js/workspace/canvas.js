...
(function() {
  define(["jQuery", "Kinetic", "workspace/assets"], function($, Kinetic, assets) {
    ...
    setupBlinkEyeImage = function(imageSrc, blinkDelay) {
      ...
      if (imageSrc == null) {
        imageSrc = assets.DOGE_BLINK_EYE;
      }
      if (blinkDelay == null) {
        blinkDelay = 10000;
      }
    ...
    addSprite = function(spriteImage) {
      ...
      if (spriteImage != null ? typeof spriteImage.attr === "function" ? spriteImage.attr("src") : void 0 : void 0) {
